    ...
    <div class="navbar navbar-inverse navbar-fixed-top" data-spy="affix" data-offset-top="100">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="inicio.php"><img class="img-responsive logo img-thumbnail" src="../img/ventas.jpeg" alt="" width="150px" height="150px"></a>
        </div>
        ...
        ?>
        <li><a href="usuarios.php"><span class="glyphicon glyphicon-user"></span> Administar usuarios</a>
          </li>
